...
depth_1_file_name = "frame0000_raw_depth.npy"
depth_2_file_name = "frame0000_rect_depth.npy"
depth_1_dir = os.path.join(
    input_data_dir, depth_1_file_name
)
depth_2_dir = os.path.join(
    input_data_dir, depth_2_file_name
)
